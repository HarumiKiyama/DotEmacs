...
(defvar tabspaces-command-map
  (let ((map (make-sparse-keymap)))
    (keymap-set map "C" 'tabspaces-clear-buffers)
    (keymap-set map "b" 'tabspaces-switch-to-buffer)
    (keymap-set map "d" 'tabspaces-close-workspace)
    (keymap-set map "k" 'tabspaces-kill-buffers-close-workspace)
    (keymap-set map "o" 'tabspaces-open-or-create-project-and-workspace)
    (keymap-set map "r" 'tabspaces-remove-current-buffer)
    (keymap-set map "R" 'tabspaces-remove-selected-buffer)
    (keymap-set map "s" 'tabspaces-switch-or-create-workspace)
    (keymap-set map "t" 'tabspaces-switch-buffer-and-tab)
    map)
